...
<div class="row">
	<div class="col-lg-7">
		<div class="panel">
			<div class="panel-heading">{l s='Klarna' mod='klarnaofficial'}</div>
            {if $show_kpm_warning}<div class="alert alert-danger">It seems you are using Klarna KPM services, which will be discontinued at the end of September 2020. Make sure to upgrade your solution in order to have customer prefill, global compliance, and a faster Klarna checkout process, among other benefits.</div>{/if}

	...
	<div class="col-lg-7">
		<div class="panel">
			...
			<div>
				...
				{if (isset($klarna_checkbox_info.text_at_time_of_purchase))}{$klarna_checkbox_info.text_at_time_of_purchase|escape:'html':'UTF-8'} {$klarna_checkbox_info.checked|escape:'html':'UTF-8'}<br />{/if}

...
{/if}
	<section class="banner banner--docs {if !$showbanner && !$showbanner1}banner--small{/if}">
		...
		<a class="banner__cta" href="https://klarnadocs.prestaworks.se?cron_token={$cron_token|escape:'url'}&cron_domain={$cron_domain|escape:'url'}" target="_blank" id="__fancydocs" title="{l s='Read documentation here' mod='klarnaofficial'}">

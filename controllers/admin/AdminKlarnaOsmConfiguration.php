        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc' => $this->l('Enter data-key for cart page placement.'). ' '.$this->l('Note: ').$this->l('PrestaShop version 1.6 is unable to properly notify when a cart\'s amount is adjusted, therefore Klarna placements that dynamically change based on amount are unable to update to the correct amount. These typically follow the naming scheme "credit-promotion-[size]", but it is recommended to review the placement within the Klarna Merchant Portal before publishing on your live store.'),
                    'name' => 'cart_page',
                ),
                array(
                    'type' => 'select',

...
class KlarnaOfficialCheckoutKlarnaKcoModuleFrontController extends ModuleFrontController
{
            ...
            if (!$this->context->cart->checkQuantities()) {
                ...
                try {
                    if (version_compare(phpversion(), '5.4.0', '<')) {
                        ...
                        if (Configuration::get('KCO_PREFILL')) {
                            if ($this->context->customer->isLogged()) {
                                ...
                                if ($this->context->cart->id_address_invoice == $this->context->cart->id_address_delivery) {
                                    ...
                                    $create['billing_address']['street_address'] = $address_delivery->address1;
                                    $create['billing_address']['care_of'] = $address_delivery->address2;
                                    $create['billing_address']['postal_code'] = $address_delivery->postcode;
                                    $create['billing_address']['city'] = $address_delivery->city;
                                    $create['billing_address']['phone'] = $address_delivery->phone_mobile;
                                }
                                /*PREFILL CUSTOMER INFO*/
                            }
                        }
                        ...
                        if ($country_information['purchase_country'] == "DE" && Configuration::get('KCOV3_DE_PREFILNOT')) {
    ...
    // {
        ...
        // } else {
            // if (0 === (int)Configuration::get('KCO_DEFAULT')) {
                // return false;
            // } elseif (1 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'sv-se', 'purchase_currency' => 'SEK', 'purchase_country' => 'SE');
            // } elseif (2 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'nb-no', 'purchase_currency' => 'NOK', 'purchase_country' => 'NO');
            // } elseif (3 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'sv-fi', 'purchase_currency' => 'EUR', 'purchase_country' => 'FI');
            // } elseif (4 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'fi-fi', 'purchase_currency' => 'EUR', 'purchase_country' => 'FI');
            // } elseif (5 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'de-de', 'purchase_currency' => 'EUR', 'purchase_country' => 'DE');
            // } elseif (6 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'de-at', 'purchase_currency' => 'EUR', 'purchase_country' => 'AT');
            // } elseif (7 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'nl-nl', 'purchase_currency' => 'EUR', 'purchase_country' => 'NL');
            // } elseif (8 === (int)Configuration::get('KCO_DEFAULT')) {
                // return array('locale' => 'en-gb', 'purchase_currency' => 'GBP', 'purchase_country' => 'GB');
            // }
            // return false;
        // }
